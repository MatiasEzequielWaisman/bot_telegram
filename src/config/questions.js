...
const QUESTIONS = [
  {
    ...
    type: 'buttons',
    options: [
      { label: 'Gestion General', value: 'Gestion General' },
      { label: 'Vestidores', value: 'Vestidores' },
      { label: 'Pintura', value: 'Pintura' },
      { label: 'Estucado y microcemento', value: 'Estucado y microcemento' },
      { label: 'Cocinas', value: 'Cocinas' },
      { label: 'Electricista', value: 'Electricista' },
      { label: 'Proovedores', value: 'Proovedores' },
    ],
    validator: 'notEmpty',
